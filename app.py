...
class AppStack(cdk.Stack):
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        L2_NODE_URL = os.environ.get("L2_NODE_URL")
        ...
        if L2_NODE_URL is None:
            raise Exception("L2_NODE_URL environment variable not set")
...
app_stack = AppStack(app, "OptimismNodeApp", env=environment)
cdk.Tags.of(app_stack).add("app", "Optimism Node")
